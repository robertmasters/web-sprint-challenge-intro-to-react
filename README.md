...
React is a library, it makes it easier to display a user experience using components
1. Describe component state.
the part of a component that changes and re-renders the component
1. Describe props.
data that is being passed down from a parent component to a child component.
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
side effects are things that happen outside of the scope of a function. the way its synced is by adding the state or props into the array after the method: useEffect(()=> {...}, ['state/prop goes here'])
